...
const redisClient = redis.createClient({host: "af-connect-redis", port: 6379});
...
const checkKeyExist = (key) => new Promise(
    (resolve, reject) => redisClient.exists(key, (err, reply) => (err) ? reject(err): resolve(reply))
);
